...
if __name__=="__main__":
    ...
    parser.add_option('--merged_file_path',type=str,help='path to merged files',dest='merged_path',default="/beegfs/u/prajwalvp/10jun20_run3/merged_filterbanks")
    ...
    for new_path in new_paths:
        if not glob.glob(new_path+'/*.meta'):
            ...
            for beam_name in unique_beam_list:
                ...
                files_per_beam = sorted(glob.glob(new_path+'/'+beam_name+'/*.fil'))[2:] # Ignore first 10 min due to  jump
